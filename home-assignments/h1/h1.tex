...
\addcontentsline{toc}{sec}{1.2 Invariant factors theorem}
...
\begin{proof}[Solution]\leavevmode
	Recall that the local ring of a point is a principal ideal domain. Since any coherent sheaf $\mathcal{F}$ is finetely generated, we may apply Invariant Factors Theorem 
\end{proof}
